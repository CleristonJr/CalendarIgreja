            ...
            <div className="md:w-1/3 mb-8 md:mb-0">
              <form action={criarMembro} className="space-y-4">
                ...
                <div>
                  ...
                  <input name="email" type="email" placeholder="roberto@igreja.com" required className="w-full text-sm border border-slate-300 rounded-lg p-2.5 focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 outline-none transition" />
                </div>
